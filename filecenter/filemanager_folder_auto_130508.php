...
// 변수
	...
	{
	// 타입정보
		$type_where = " and code.comp_idx = '" . $code_comp . "' and code.part_idx = '" . $code_part . "' and code.menu_depth = '1' and code.view_yn = 'Y'";
...
<div class="ajax_write">
	<div class="upload_title">
		<strong>폴더생성</strong>
		<img src="/bizstory/images/filecenter/icon_close.png" onclick="popupform_close(); list_data();" alt="닫기" />
	</div>
