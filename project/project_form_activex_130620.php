		...
		<form id="postform" name="postform" method="post" class="writeform" action="<?=$this_page;?>">
			...
			<fieldset>
				...
				<?
					if ($pro_idx == '') {
				?>
						<span class="btn_big_green"><input type="button" value="등록" onclick="CHXFile.Upload();" /></span>
				...
				?>
						<span class="btn_big_blue"><input type="button" value="수정" onclick="CHXFile.Upload();" /></span>
