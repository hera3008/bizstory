...
<div class="ajax_write">
	<div class="ajax_frame">
		...
		<form id="postform" name="postform" method="post" class="writeform" action="<?=$this_page;?>">
            <input type="hidden" name="menu1" id="menu1" />
            <input type="hidden" name="menu2" id="menu2" />
			...
			<fieldset>
				...
				?>
						...
						<input type="hidden" name="sub_type" id="sub_type" value="post" />
				<?
					} else {
				?>
				<?
				...
				?>
						...
						<input type="hidden" name="sub_type" id="sub_type" value="modify" />
				<?
					}
				?>
