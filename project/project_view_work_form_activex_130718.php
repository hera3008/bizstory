...
<?
	include $local_path . "/bizstory/project/project_form_work_form_js.php";
?>
	...
	function popup_file()
	{
		$.ajax({
			...
			success: function(msg) {
				...
				$("#backgroundPopup2").css({"opacity": "0.7",'width':'100%','height':'100%'}).fadeIn("slow");
				$("#data_form2").slideDown("slow");
				$('.popupform2').css('top',  "80px");
				$('.popupform2').css('left', maskWidth/2-($('.popupform').width()/2));
				$("#data_form2").html(msg);
			}
		});
	}
