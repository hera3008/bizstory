...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
// 링크, 버튼
	$link_list = $local_dir . "/sole/company/company_list.php"; // 목록
	$link_view = $local_dir . "/sole/company/company_view.php"; // 보기
		...
		<form id="searchform" name="searchform" method="post" action="<?=$this_page;?>" onsubmit="return check_search();">
			...
			<div class="search">
				<select id="search_swhere" name="swhere" title="<?=$search_column;?>">
					...
					<option value="comp.boss_name"  <?=selected($swhere, 'comp.comp_name');?>>대표자명</option>
					<option value="comp.charge_name"<?=selected($swhere, 'comp.comp_name');?>>담당자명</option>
					<option value="comp.tel_num"    <?=selected($swhere, 'comp.comp_name');?>>전화번호</option>
					<option value="comp.address"    <?=selected($swhere, 'comp.comp_name');?>>주소</option>
					<option value="comp.comp_email" <?=selected($swhere, 'comp.comp_name');?>>메일주소</option>
				</select>
