...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
// 링크, 버튼
	$link_list  = $local_dir . "/bizstory/comp_set/agent_icon_list.php"; // 목록
	$link_form  = $local_dir . "/bizstory/comp_set/agent_icon_form.php"; // 등록
	$link_ok    = $local_dir . "/bizstory/comp_set/agent_icon_ok.php";   // 저장
...
<div class="tablewrapper">
	...
	<form id="listform" name="listform" method="post" action="<?=$this_page;?>" onsubmit="return check_form()">
