...
?>
                                                    ...
                                                    <form id="postform" name="postform" method="post" class="form" action="<?=$this_page;?>" onsubmit="return check_form()">
                                                        ...
                                                        <?}else{?>
                                                            <div class="row py-2">
                                                                <div class="col-3">
                                                                    <label for="post_group_name"
                                                                        class="fs-7 fw-semibold my-3">
                                                                        <span class="required">기업명</span>
                                                                    </label>
                                                                </div>
                                                                <div class="col-9 fv-row fv-plugins-icon-container">
                                                                    <input type="text" name="param[comp_name]" id="post_comp_name" title="기업명 입력하세요."
                                                                        class="form-control form-control-sm maxlength" placeholder="기업명 입력하세요." maxlength="25"
                                                            ...
                                                            <div class="row py-2">
                                                                ...
                                                                <div class="col-9 fv-row fv-plugins-icon-container">
                                                                <input type="text" name="param[comp_tel_num]" id="post_comp_tel_num" title="연락처를 입력하세요."
                                                                        class="form-control form-control-sm maxlength" placeholder="연락처를 입력하세요." maxlength="25"
                                                                        value="<?=$data['comp_tel_num'];?>">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="row py-2">
                                                                ...
                                                                <div class="col-9 fv-row fv-plugins-icon-container">
                                                                <input type="text" name="param[comp_address]" id="post_comp_address" title="주소를 입력하세요."
                                                                            class="form-control form-control-sm maxlength" placeholder="주소를 입력하세요." maxlength="25"
                                                        ...
                                                        <div class="modal-footer">
														    <button type="button" class="btn btn-sm btn-secondary d-print-none" data-bs-dismiss="modal" onclick="location.href = '<?=$this_page;?>?<?=$f_all;?>'";>
