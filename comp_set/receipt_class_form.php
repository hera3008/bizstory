...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
	if ($form_chk == 'Y')
	{
		...
		$where = " and ";
		$where .= "( code.comp_idx = '" . $code_comp . "' ";
		if($comp_info['sc_code']) $where .= "  or code.sc_code = '" . $comp_info['sc_code'] . "' ";
		if($comp_info['schul_code']) $where .= "  or code.schul_code = '" . $comp_info['schul_code'] . "' ";
		$where .=")";
		//$where .= " and code.part_idx = '" . $code_part . "'";
