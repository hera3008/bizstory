...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
// 링크, 버튼
	$link_list = $local_dir . "/bizstory/comp_set/receipt_class_list.php"; // 목록
	$link_form = $local_dir . "/bizstory/comp_set/receipt_class_form.php"; // 등록
	$link_ok   = $local_dir . "/bizstory/comp_set/receipt_class_ok.php";   // 저장
	$link_up   = $local_dir . "/bizstory/comp_set/receipt_class_up.php";   // 상위
?>
					 <!-- Content wrapper -->
                            ...
                            <div id="kt_content_container"
                                ...
                                <div class="card card-flush">
                                    <div
                                        ...
                                        <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                                            <ol
                                                ...
                                                <li class="breadcrumb-item text-gray-700">접수분류</li>
                                            </ol>
                                        </div>
                                    </div>
                                    <div class="card-body px-6 px-lg-9 py-2 py-lg-3">
										...
										<!-- 글목록 -->
                                        <div id="data_list">											
                                            <? include_once("{$local_path}/bizstory/comp_set/receipt_class_list.php"); ?>
                                        </div>
										<!-- //글목록 -->
