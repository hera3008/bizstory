...
// 에디터관련
	...
	file_setting('file_fname2', 'company', '1', '<?=$file_multi_size;?>', '');
	file_setting('file_fname3', 'company', '1', '<?=$file_multi_size;?>', '');
	file_setting('file_fname4', 'company', '1', '<?=$file_multi_size;?>', '');
	file_setting('file_fname<?=$cert_num;?>', 'company', '1', '<?=$file_multi_size;?>', '');
