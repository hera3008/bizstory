...
// 등록 함수
    ...
    // 그외 저장 파일
        ...
        for ($i = 2; $i <= $file_num; $i++)
        {
            ...
            if ($i == 1) $chk_file_subject = $param['mem_name'] . ' 사진';
	...
	// 해당메뉴권한설정
		$auth_where = "";
		$auth_where .= $comp_idx ? " and mc.comp_idx = '" . $comp_idx . "'" : "";
		$auth_where .= $part_idx ? " and mc.part_idx = '" . $part_idx . "'" : "";
...
// 메뉴권한 함수
	...
	// 데이타 확인
		$where = " and mam.mem_idx = '" . $mem_idx . "' and mam.mi_idx = '" . $mi_idx . "'";
		$where .= $comp_idx ? " and mam.comp_idx = '" . $comp_idx . "'" : "";
