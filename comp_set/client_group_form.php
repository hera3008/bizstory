...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
	if ($form_chk == 'Y')
	{
		...
		$depth_data = query_view("select max(menu_depth) as max_depth from company_client_group where " . $where ." limit 1");
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h3 class="modal-title">거래처 분류 등록</h3>
                                                    ...
                                                    <form id="postform" name="postform" method="post" class="form" action="<?=$this_page;?>" onsubmit="return check_form()">
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="row py-2">
                                                                ...
                                                                <div class="col-9 fv-row fv-plugins-icon-container">
                                                                    <select name="param[menu_depth]" id="post_menu_depth" 
                                                                        ...
                                                                        title="분류단계를 선택해 주세요"
																		class="form-select form-select-sm" onchange="up_menu_change(this.value, '<?=$ccg_idx;?>', '');">
                                                            ...
                                                            <div class="row py-2">
                                                                ...
                                                                <div class="col-9 fv-row fv-plugins-icon-container">
                                                                    <input type="hidden" name="param[group_code]" id="post_group_code" value="<?=$data['group_code'];?>"    >
                                                            ...
                                                            <div class="row py-2">
                                                                ...
                                                                <div class="col-9 fv-row fv-plugins-icon-container">
                                                                    <input type="text" name="param[group_name]" id="post_group_name" title="분류명을 입력하세요."
