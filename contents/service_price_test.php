	...
	<div id="container">
		<div class="contents">
			...
			<table class="list b_t" border="1" cellspacing="0" summary="">
				...
				<tbody>
					<tr>
						<th scope="row" class="t_bg_2 c267db1" colspan="4">비즈스토리 Premium Service는 Standard Service가 기본으로 포함되어 있습니다.</th>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>3,000 GB (10인 기준) 월 사용료 -원</td>
						<td></td>
					</tr>
					<tr>
						<td>35,000 GB (20인 기준) 월 사용료 -원</td>
						<td></td>
					</tr>
					<tr>
						<td>8,000 GB (30인 기준) 월 사용료 -원</td>
						<td></td>
					</tr>
				</tbody>
			</table>
