...
<body id="login_layout" class="login">
	...
	<div id="container">	
		<div id="lnb">	
			<ul>
				<li><a href="<?=$local_dir;?>/contents/service_notice.php">공지사항</a></li>			
				<li><a href="<?=$local_dir;?>/contents/service_faq.php">자주묻는 질문</a></li>		
				<li class="on"><a href="<?=$local_dir;?>/contents/service_suggest.php">건의사항</a></li>			
			</ul>
		</div>
		...
		<div class="contents">
			...
			<h4 class="mt35">건의사항 / 기술문의</h4>	
			
			<p class="txt">
				최고의 기술로 최상의 서비스를 제공합니다.<br />
				비즈스토리 관련 건의사항, 기술문의가 필요하시면 연락주시기 바랍니다.
			</p>
			
			<h5 class="tit2 mt25">(주)유비스토리</h5>
			<dl class="dl_box">
				<dt><img src="<?=$local_dir;?>/contents/images/ubstory.png" class="mt15" alt="ubstory" /></dt>
				<dd>
					문의번호 : 1544-7325 (내선 2번)<br />
					이메일 : ubsns@ubstory.net<br />
					(※ 일요일 및 공휴일 기술지원 문의 : 010-8925-4862)
				</dd>
			</dl>
			
			<h5 class="tit2 mt25">건솔루션(주)</h5>
			<dl class="dl_box">
				<dt><img src="<?=$local_dir;?>/contents/images/gunsolution.png" alt="gunsolution" /></dt>
				<dd>
					문의번호 : 1899-7487<br />
					팩스번호 : 0502-388-7449
				</dd>
			...
			<h5 class="tit2 mt25">(주)에이블스토어</h5>
			<dl class="dl_box">
				<dt><img src="<?=$local_dir;?>/contents/images/ablestor.png" class="mt15" alt="ablestor" /></dt>
				<dd>
					문의번호 : 02-456-7667<br />
					팩스번호 : 02-456-7262
				</dd>
			...
			<p class="txt mt15">
				※ 고객지원 근무시간 : 09:00-18:00 (근무시간 이외의 문의는 이메일로 연락바랍니다.)<br />
				※ 문의하신 내용은 24시간 이내에 이메일로 답변드리며, 이메일로 답변이 어려운경우 연락드릴 수 있으니 연락처를 알려주시면 연락드릴 수 있습니다.
			</p>
