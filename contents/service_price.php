	...
	<div id="container">
		<div class="contents">
			...
			<table class="list" border="1" cellspacing="0" summary="">
				<caption>Maintenance 서비스 상세내역</caption>
				<colgroup>
					<col width="10%" />
					<col width="15%" />
					<col width="15%" />
				...
				<thead>
					<tr>
						<th colspan="3" scope="col" class="t_bg2">기능분류</th>
						<th scope="col" class="t_bg2">BIZSTORY MAINTENANCE Service</th>
						<th scope="col" class="t_bg2">추가항목</th>
						<th scope="col" class="t_bg2">월 사용료</th>
					</tr>
				</thead>
				<tbody>
					<tr>
						<th rowspan="4" scope="row" class="t_bg2_2">기 본</th>
						<th rowspan="2" scope="row" class="t_bg2_2">업무관리</th>
						<th scope="row" class="t_bg2_2">등록거래처 수</th>
						<td>20개</td>
						<td>지사 1개소</td>
						<td rowspan="4">88,000원<br />(VAT포함)</td>
					</tr>
					<tr>
						<th scope="row" class="t_bg2_2">Agent 배포</th>
						<td scope="row">무제한</td>
						<td></td>
					</tr>
					<tr>
						<th scope="row" class="t_bg2_2">사용유저</th>
						<th scope="row" class="t_bg2_2">직원등록관리</th>
						<td>20인</td>
						<td></td>
					</tr>
					<tr>
					...
					<tr>
						<th rowspan="3" scope="row" class="t_bg2_2">추 가</th>
						<th scope="row" class="t_bg2_2">업무관리</th>
						<th scope="row" class="t_bg2_2">등록거래처 수</th>
						<td>20개</td>
						<td></td>
						<td rowspan="3">44,000원<br />(VAT포함)</td>
					</tr>
					<tr>
						<th scope="row" class="t_bg2_2">사용유저</th>
						<th scope="row" class="t_bg2_2">직원등록관리</th>
			...
			<h5 class="mt35">Standard Service</h5>
			<table class="list" border="1" cellspacing="0" summary="">
				<caption>Standard 서비스 상세내역</caption>
				<colgroup>
					<col width="20%" />
					<col width="35%" />
					<col width="*" />
			...
			<table class="list b_t" border="1" cellspacing="0" summary="">
				<caption>Premium 서비스 상세내역</caption>
				<colgroup>
					<col width="20%" />
					<col width="35%" />
					<col width="*" />
