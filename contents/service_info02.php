	...
	<div id="container">
		<div id="lnb">	
			<ul>
				...
				<li class="on"><a href="<?=$local_dir;?>/contents/service_info02.php">유지보수형</a></li>		
		...
		<div class="contents">
			...
			<p class="under_line"><img src="<?=$local_dir;?>/contents/images/01_02_img1.png" alt="전화업무 70% 감소 스마트한 접수" /></p>
			<p class="under_line"><img src="<?=$local_dir;?>/contents/images/01_02_img2.png" alt="기능소개-상담계약" /></p>
			<p class="under_line"><img src="<?=$local_dir;?>/contents/images/01_02_img3.png" alt="기능소개-필요기능 설명" /></p>
			<p><img src="<?=$local_dir;?>/contents/images/01_02_img4.png" alt="기능소개-Biz-On 배포" /></p>
			<p class="under_line"><img src="<?=$local_dir;?>/contents/images/01_02_img5.png" alt="기능소개-Biz-On 배포" /></p>
			<p class="under_line"><img src="<?=$local_dir;?>/contents/images/01_02_img6.png" alt="기능소개-스마트 접수 관리" /></p>
			<p class="under_line"><img src="<?=$local_dir;?>/contents/images/01_02_img7.png" alt="기능소개-언제 어디서나 A/S 접수" /></p>
			<p><img src="<?=$local_dir;?>/contents/images/01_02_img8.png" alt="기능소개-AS 분석 월별 보고서 자동 생성" /></p>
