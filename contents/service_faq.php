	...
	<div id="container">
		<div id="lnb">	
			<ul>
				...
				<li class="on"><a href="<?=$local_dir;?>/contents/service_faq.php">자주묻는 질문</a></li>		
		...
		<div class="contents">
			...
			<h4 class="mt35">자주묻는 질문</h4>	
			
			<h5 class="tit mt15">업무형</h5>
			<ul class="faq">
			    <li>
			        <a href="#" title="View Answer">비즈스토리 & 유비스토리 회사 소개 자료는 어떻게 받나요?</a>
			        <p>
			          	 고객센터(1544-7325)나 이메일을 남겨주시면 회사 소개 자료를 발송해드리겠습니다.
			        </p>
			    </li>
			    <li>
			        <a href="#" title="View Answer">서비스 기한이 만료되었습니다. 기한을 연장하려면 어떻게 해야 하나요?</a>
			        <p>
			           	 고객센터(1544-7325)나 이메일을 남겨주시면 연락드리겠습니다.
			        </p>
			    </li>
			</ul>
			
			<h5 class="tit mt35">유지보수형</h5>
			<ul class="faq">
			    <li>
			        <a href="#" title="View Answer">서비스 준비중입니다.</a>
			        <p>
			          	현재 서비스 준비중입니다.
			        </p>
			    </li>
