				...
				<section class="setting_area">
					<ul class="setting">
						<li>
							...
							<div class="ez-checkbox2">
								<input type="checkbox" name="chk_alarm" id="chk_alarm" value="Y" <?=checked($push_enable, 'Y');?> onclick="javascript:alarm_setting();" class="ez-hide" />
							</div>
						</li>
						<li>
							<strong>쪽지알람</strong>
							<div class="ez-checkbox2">
								<input type="checkbox" name="chk_message" id="chk_message" value="Y" <?=checked($push_message, 'Y');?> onclick="javascript:alarm_setting();" class="ez-hide" />
							</div>
						</li>
						<li>
							<strong>접수알람</strong>
							<div class="ez-checkbox2">
								<input type="checkbox" name="chk_receipt" id="chk_receipt" value="Y" <?=checked($push_receipt, 'Y');?> onclick="javascript:alarm_setting();" class="ez-hide" />
							</div>
						</li>
						<li>
							<strong>업무알람</strong>
							<div class="ez-checkbox2">
								<input type="checkbox" name="chk_work" id="chk_work" value="Y" <?=checked($push_work, 'Y');?> onclick="javascript:alarm_setting();" class="ez-hide" />
							</div>
						</li>
						<li>
							<strong>상담알람</strong>
							<div class="ez-checkbox2">
								<input type="checkbox" name="chk_consult" id="chk_consult" value="Y" <?=checked($push_consult, 'Y');?> onclick="javascript:alarm_setting();" class="ez-hide" />
							</div>
						</li>
						<li>
							<strong>단문자알람</strong>
							<div class="ez-checkbox2">
								<input type="checkbox" name="chk_sms" id="chk_sms" value="Y" <?=checked($push_sms, 'Y');?> onclick="javascript:alarm_setting();" class="ez-hide" />
							</div>
						</li>
						<li class="end">
							<strong>공지알람</strong>
