			...
			<fieldset>
				...
				?>
					...
					?>
									<li>
										<?=$btn_str;?>
										<a href="<?=$local_dir;?>/cms/receipt_download.php?rf_idx=<?=$file_data['rf_idx'];?>" title="<?=$file_data['img_fname'];?> 다운로드" class="fileicon"><?=$file_data['img_fname'];?> (<?=$fsize;?>)</a>
									</li>
					<?
								}
							}
...
//------------------------------------ 댓글 관련
	var comment_list = '<?=$local_dir;?>/cms/receipt_view_comment_list.php';
	var comment_form = '<?=$local_dir;?>/cms/receipt_view_comment_form.php';
	var comment_ok   = '<?=$local_dir;?>/cms/receipt_view_comment_ok.php';
