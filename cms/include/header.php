...
<? // Start Stylesheets ?>
<link type="text/css" rel="stylesheet" href="<?=$local_dir;?>/cms/css/common.css" media="all" />
<!--[if IE 7]>
	<style type="text/css">
...
<![endif]-->
<script type="text/javascript" src="<?=$local_dir;?>/cms/js/common.js" charset="utf-8"></script>
