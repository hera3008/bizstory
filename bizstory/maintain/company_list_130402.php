...
// 변수
	...
	{
		$btn_write = '<a href="javascript:void(0);" onclick="popupform_open(\'\')" class="btn_big"><span>등록</span></a>';
	}
?>
<div class="info_text">
	<ul>
...
?>
		<tr>
			...
			<td>
				<a href="javascript:void(0);" onclick="<?=$btn_move;?>" class="btn_con"><span>페이지보기</span></a><br />
				<a href="javascript:void(0);" onclick="<?=$btn_menu;?>" class="btn_con"><span>메뉴설정</span></a><br />
...
?>
		<tr>
			<td colspan="12"></td>
			<td colspan="2"><span class="eng right"><?=number_format($total_price);?></span></td>
			<td colspan="2">&nbsp;</td>
		</tr>
	</tbody>
</table>
