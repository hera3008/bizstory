...
e.prepend('<div class="xupload_wrapper xupload_scroll">\
	<div id="'+f+'_container" class="xupload_container">\
		<div class="plupload">\
			<div class="xupload_content">\
				<div class="xupload_filelist_header">\
					<div class="xupload_file_name">파일 이름</div>\
					<div class="xupload_file_action">&nbsp;</div>\
					<div class="xupload_file_status"><span>상태</span></div>\
					<div class="xupload_file_size">크기</div>\
					<div class="xupload_clearer">&nbsp;</div>\
				</div>\
				<ul id="'+f+'_filelist" class="xupload_filelist"></ul>\
				<div class="xupload_filelist_footer">\
					<div class="xupload_file_name">\
						<div class="xupload_buttons">\
							<a href="#" class="xupload_button xupload_add"><span>파일 추가</span></a>\
							<!--//<a href="#" class="xupload_button xupload_start"><span>파일 전송</span></a>//-->\
						</div>\
						<span class="xupload_upload_status"></span>\
					</div>\
					<div class="xupload_file_action"></div>\
					<div class="xupload_file_status"><span class="xupload_total_status">0%</span></div>\
					<div class="xupload_file_size"><span class="xupload_total_file_size">0 b</span></div>\
					<div class="xupload_progress">\
						<div class="xupload_progress_container">\
							<div class="xupload_progress_bar"></div>\
						</div>\
					</div>\
					<div class="xupload_clearer">&nbsp;</div>\
				</div>\
	...
	<input type="hidden" id="'+f+'_count" name="'+f+'_count" value="0" />\
</div>')}
...
else{c("span.xupload_add_text",i).text(j.total.queued+" files queued.")}
c("a.xupload_start",i).toggleClass("xupload_disabled",j.files.length==(j.total.uploaded+j.total.failed));
...
c("a.xupload_add",i).attr("id",k+"_browse");l.settings.browse_button=k+"_browse";if(l.features.dragdrop&&l.settings.dragdrop){l.settings.drop_element=k+"_filelist";c("#"+k+"_filelist").append('<li class="xupload_droptext">첨부하실 파일을 여기에 끌어 놓으세요.</li>')}c("#"+k+"_container").attr("title","Using runtime: "+m.runtime);
c("a.xupload_start",i).click(function(n){if(!c(this).hasClass("xupload_disabled")){j.start()}n.preventDefault()});
c("a.xupload_stop",i).click(function(n){n.preventDefault();j.stop()});
c("a.xupload_start",i).addClass("xupload_disabled")});j.init();
