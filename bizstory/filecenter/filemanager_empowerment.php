...
<div class="ajax_write">
    ...
    <div class="ajax_frame">
        <form id="postform" name="postform" method="post" class="writeform" action="<?=$this_page;?>" onsubmit="return chk_submit()">
            <input type="hidden" id="sub_type"   name="sub_type" value="auth_empowerment" />
            <input type="hidden" id="sub_action" name="sub_action" />
            <input type="hidden" name="fi_idx" id="fi_idx" />
            <input type="hidden" name="target_mem_idx" id="target_mem_idx" />
            
            <input type="hidden" name="dir_view" id="dir_view" value="0" />
            <input type="hidden" name="dir_read" id="dir_read" value="0" />
            <input type="hidden" name="dir_write" id="dir_write" value="0" />
            <input type="hidden" name="dir_delete" id="dir_delete" value="0" />
            <?=$form_all;?>

            <fieldset>
                <legend class="blind"><?=$form_title;?> 폼</legend>

                <table class="tinytable write" summary="권한을 부여합니다.">
                    ...
                    <div style="float:left">
                        <ul id="type_folder_navi">
                            ...
                            <li class="directory collapsed">
                                ...
                                <tbody>
                                    <tr>
                                        <td><img src="<?=$local_dir?>/bizstory/images/icon/N.gif" alt="N" class="pointer" onclick="auth_change(this, 'dir_view')" id="btn_dir_view" val="1"/></td>
                                        <td><img src="<?=$local_dir?>/bizstory/images/icon/N.gif" alt="N" class="pointer" onclick="auth_change(this, 'dir_read')" id="btn_dir_read" val="1"/></td>
                                        <td><img src="<?=$local_dir?>/bizstory/images/icon/N.gif" alt="N" class="pointer" onclick="auth_change(this, 'dir_write')" id="btn_dir_write" val="1"/></td>
                                        <td><img src="<?=$local_dir?>/bizstory/images/icon/N.gif" alt="N" class="pointer" onclick="auth_change(this, 'dir_delete')" id="btn_dir_delete" val="1"/></td>
                                    </tr>
                                </tbody>
                                </table>
