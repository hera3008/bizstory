...
function setConfing () {
    ...
    this.ServerURL = 'http://220.90.128.141/filecenter/biz/download/download.php';

    // 파일 정보를 리턴하는 서버 사이드 스크립트 URL 주소
    this.ServerFileInfo = 'http://220.90.128.141/filecenter/biz/download/fileinfo.php';
