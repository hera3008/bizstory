...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
// 링크, 버튼
	$link_list = $local_dir . "/bizstory/tong/receipt_staff_list.php"; // 목록
?>
<div class="tablewrapper">
	...
	<div id="tableheader">
		...
		<? include $local_path . "/bizstory/comp_set/staff_menu_inc.php"; ?>
	...
	<form id="listform" name="listform" method="post" action="<?=$this_page;?>">
		...
		<input type="hidden" id="list_code_staff"  name="code_staff"  value="<?=$code_staff;?>" />
...
<script>
	function check_csg_idxs() {
		//$('#csf_idxs option:selected').each(function() {
	...
	function move_staff(staff_idx)
	{
		$('#list_code_staff').val(staff_idx);
		$('#staff_menu a').removeClass('select');
		$('#staff_' + staff_idx).addClass('select');
...
//------------------------------------ 검색
	function check_search(list_type)
	{
		...
		$('#list_code_staff').val(getSelectedOptions('csg_idxs'));
	...
	function down_excel(list_type) {
		...
		form.target = "_blank";
		form.action = "./bizstory/tong/receipt_staff_excel.php";
		form.submit();
		return false;
	}
