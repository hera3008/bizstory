...
<div class="ajax_write">
	...
	<div class="ajax_frame">
		<form id="postform" name="postform" method="post" class="writeform" action="<?=$this_page;?>" onsubmit="return check_form()">
			...
			<fieldset>
				<legend class="blind">업무상태 폼</legend>
				<table class="tinytable write" summary="업무상태를 <?=$form_title;?>합니다.">
				<caption>업무상태</caption>
				<colgroup>
					<col width="120px" />
					<col />
					<col width="120px" />
				...
				<tbody>
					...
					<tr>
						<th><label for="post_code_name">업무상태명</label></th>
						<td colspan="3">
							<div class="left">
								<input type="text" name="param[code_name]" id="post_code_name" value="<?=$data['code_name'];?>" size="25" title="업무상태명을 입력하세요." class="type_text"<?=$name_style;?> readonly="readonly" />
							</div>
						</td>
					</tr>
					<tr>
