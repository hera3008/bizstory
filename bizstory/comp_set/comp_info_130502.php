				...
				<tr>
					<td colspan="2">
						<div class="left textarea_span">
							<textarea name="param[comp_remark]" id="post_comp_remark" title="내용을 입력하세요." rows="10" cols="50" class="none"><?=$data['comp_remark'];?></textarea>
						</div>
					</td>
				</tr>
			</tbody>
...
?>
			<div class="sub_frame">
				<h4>인증서
				<span class="btn_sml"><input type="button" value="추가" onclick="file_add_form('file_table')" /></span></h4>
			</div>
			<div class="right">
				<?=$btn_img;?>
