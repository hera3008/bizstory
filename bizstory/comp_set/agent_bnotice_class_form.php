...
/*
	생성 : 2012.10.24
	위치 : 코드관리 > 에이전트관리 > 알림게시판 > 알림분류 - 등록, 수정
*/
...
// 변수
	...
	if ($form_chk == 'Y')
	{
		...
		$depth_data = query_view("
			select max(menu_depth) as max_depth from code_bnotice_class
			...
			<fieldset>
				...
				<tbody>
					...
					<tr>
						...
						<td colspan="3">
							<div class="left">
								<select name="param[menu_depth]" id="post_menu_depth" onchange="up_menu_change(this.value, '<?=$code_idx;?>');" title="분류단계를 선택하세요.">
