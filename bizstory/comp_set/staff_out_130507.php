...
// 링크, 버튼
	...
	$link_form         = $local_dir . "/bizstory/comp_set/staff_out_form.php";      // 등록
	$link_view         = $local_dir . "/bizstory/comp_set/staff_out_view.php";      // 보기
	$link_ok           = $local_dir . "/bizstory/comp_set/staff_out_ok.php";        // 저장
	$link_excel        = $local_dir . "/bizstory/comp_set/staff_out_excel.php";     // 액셀
	$link_print        = $local_dir . "/bizstory/comp_set/staff_out_print.php";     // 인쇄
	$link_print_detail = $local_dir . "/bizstory/comp_set/staff_out_print_sel.php"; // 상세인쇄
