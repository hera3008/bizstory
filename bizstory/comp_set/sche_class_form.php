...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
	if ($form_chk == 'Y')
	{
		...
		$data = code_sche_class_data("view", $where);
...
<div class="ajax_write">
	...
	<div class="ajax_frame">
		<form id="postform" name="postform" method="post" class="writeform" action="<?=$this_page;?>" onsubmit="return check_form()">
			...
			<fieldset>
				<legend class="blind">일정종류 폼</legend>
				<table class="tinytable write" summary="일정종류를 <?=$form_title;?>합니다.">
				<caption>일정종류</caption>
				<colgroup>
					<col width="120px" />
					<col />
				</colgroup>
				<tbody>
					...
					<tr>
						<th><label for="post_code_name">일정종류명</label></th>
						<td colspan="3">
							<div class="left">
								<input type="text" name="param[code_name]" id="post_code_name" value="<?=$data['code_name'];?>" size="25" title="일정종류명을 입력하세요." class="type_text"<?=$name_style;?> />
							</div>
						</td>
					</tr>
					<tr>
