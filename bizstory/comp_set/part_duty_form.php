...
// 변수
	...
	$form_chk = 'N';
	if ($auth_menu['int'] == 'Y' && $cpd_idx == '') // 등록권한
	{
		$form_chk   = 'Y';
		$form_title = '등록';
	}
	else if ($auth_menu['mod'] == 'Y' && $cpd_idx != '') // 수정권한
	{
		$form_chk   = 'Y';
		$form_title = '수정';
	}
...
<div class="ajax_write">
	...
	<div class="ajax_frame">
		<form id="postform" name="postform" method="post" class="writeform" action="<?=$this_page;?>" onsubmit="return check_form()">
			...
			<fieldset>
				<legend class="blind">직책관리 폼</legend>
				<table class="tinytable write" summary="직책관리를 <?=$form_title;?>합니다.">
				<caption>직책관리</caption>
				<colgroup>
					<col width="120px" />
					<col />
					<col width="120px" />
				...
				<tbody>
					...
					<tr>
						<th><label for="post_duty_name">직책명</label></th>
						<td colspan="3">
							<div class="left">
								<input type="text" name="param[duty_name]" id="post_duty_name" value="<?=$data['duty_name'];?>" size="25" title="직책명을 입력하세요." class="type_text" />
							</div>
						</td>
					</tr>
					<tr>
				...
				?>
						...
						<input type="hidden" name="cpd_idx" value="<?=$cpd_idx;?>" />
				<?
					}
				?>
					</div>
