...
// 등록 함수
	...
	// 기본값설정
		if ($param['default_yn'] == 'Y')
		{
			...
			$page_data = code_work_class_data("page", $where);
...
//위 정렬 함수
	function sort_up()
	{
		...
		$prev_data = code_work_class_data('view', $sort_where, $sort_order);
...
//아래 정렬 함수
	function sort_down()
	{
		...
		$next_data = code_work_class_data('view', $sort_where, $sort_order);
