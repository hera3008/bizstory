...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
// 링크, 버튼
	$link_list = $local_dir . "/bizstory/comp_set/client_group_list.php"; // 목록
	$link_form = $local_dir . "/bizstory/comp_set/client_group_form.php"; // 등록
	$link_ok   = $local_dir . "/bizstory/comp_set/client_group_ok.php";   // 저장
	$link_up   = $local_dir . "/bizstory/comp_set/client_group_up.php";   // 상위
?>
...
//------------------------------------ 단계변경
	function up_menu_change(menu_depth, idx)
	{
		...
		$.ajax({
			...
			data: {"menu_depth" : menu_depth, "ccg_idx" : idx, "code_part" : $('#post_part_idx').val()},
			success: function(msg) {
