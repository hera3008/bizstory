...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	$form_chk = 'N';
	if ($auth_menu['int'] == 'Y' && $ci_idx == '') // 등록권한
	{
		if ($page_data['total_num'] >= $set_client_cnt) // 거래처수확인
		{
			echo '
				...
				//<![CDATA[
					check_auth_popup("' . $set_client_cnt . '개까지 등록이 가능합니다.<br />더이상 등록할 수 없습니다.");
				//]]>
				</script>';
			exit;
		}
	...
	else if ($auth_menu['mod'] == 'Y' && $ci_idx != '') // 수정권한
	{
		$form_chk   = 'Y';
		$form_title = '수정';
	}
		...
		<fieldset>
			...
			?>
				...
				<?
					...
					{
				?>
							담당자명 : <input type="text" name="post_charge_name1" id="post_charge_name1" class="type_text" title="담당자명 입력하세요." size="15" />,
							...
							메일주소 : <input type="text" name="post_charge_email1" id="post_charge_email1" class="type_text" title="이메일 입력하세요." size="30" />
							<a href="javascript:void(0);" onclick="add_charge_info();" class="btn_sml_violet"><span>추가</span></a>
				<?
					}
					else
					{
				...
				?>
							...
							<a href="javascript:void(0);" onclick="add_ip_info();" class="btn_sml_violet"><span>추가</span></a>
				<?
					}
					else
					{
				...
				<tr>
					...
					<td colspan="3">
						<div class="left">
							...
							<a href="javascript:void(0);" onclick="execDaumPostcode('tax_zip');" class="btn_sml_violet"><span>우편번호찾기</span></a>
						</div>
						<div class="left mt">
...
?>
		<div id="task_cuser" class="report_box">
			<div class="report_top">
				...
				<div class="new" id="cuser_new_btn"><img src="<?=$lcoal_dir;?>/bizstory/images/btn/btn_cuser.png" alt="사용자등록" class="pointer" onclick="cuser_insert_form('open');" /></div>
			</div>
...
?>
		<div id="task_contract" class="report_box">
			<div class="report_top">
				...
				<div class="new" id="contract_new_btn"><img src="<?=$lcoal_dir;?>/bizstory/images/btn/btn_contract.png" alt="계약등록" class="pointer" onclick="contract_insert_form('open');" /></div>
			</div>
