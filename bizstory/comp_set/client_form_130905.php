				...
				<tr>
					...
					<td colspan="3">
						<div class="left">
							...
							<a href="javascript:void(0);" onclick="check_address_find2();" class="btn_sml_violet"><span>우편번호찾기</span></a>
						</div>
						<div class="left mt">
...
?>
		<div id="task_cuser" class="report_box">
			<div class="report_top">
				...
				<div class="new" id="cuser_new_btn">
					<a href="javascript:void(0);" onclick="cuser_insert_form('open');" class="btn_sml_green"><span>사용자등록</span></a>
				</div>
			</div>
...
?>
		<div id="task_contract" class="report_box">
			<div class="report_top">
				...
				<div class="new" id="contract_new_btn">
					<a href="javascript:void(0);" onclick="contract_insert_form('open');" class="btn_sml_green"><span>계약등록</span></a>
				</div>
			</div>
