	...
	<div class="ajax_frame">
			...
			<fieldset>
				...
				?>
					...
					<tr>
                        ...
                        <td>
                            <div class="left">
                                <?=code_radio($set_use, "param[empowerment_yn]", "post_empowerment_yn", $data["empowerment_yn"]);?>
                            </div>
                        </td>
					</tr>
					<tr>
		...
		<?
			...
			// 추가파일
				...
				$total_file_num = $file_list['total_num'];
			}else{
				$total_file_num = 1;
			}
		...
		?>
			...
			<input type="hidden" id="file_upload_num" name="file_upload_num" value="<?=$total_file_num;?>" />
			...
			<fieldset>
				...
				<tbody>
					<tr>
						<th><label for="file_fname">사진</label></th>
						<td colspan="2">
							<div class="filewrap">
				<?
				...
				?>
					<tr>
						<th><label for="file_subject<?=$file_chk;?>">추가파일 <?=$file_chk;?></label></th>
						<td>
							<div class="left file">
								<input type="text" name="file_subject<?=$file_chk;?>" id="file_subject<?=$file_chk;?>" value="<?=$file_data['subject'];?>" class="type_text" placeholder="추가파일제목을 입력하세요."/>
				...
				?>
					<tr>
						...
						<td>
							<div class="left file">
								<input type="text" name="file_subject<?=$file_chk;?>" id="file_subject<?=$file_chk;?>" class="type_text" placeholder="추가파일제목을 입력하세요." style="width:59%"/>
								<div style="width:100%">
...
//<![CDATA[
	...
	var file_upload_num = parseInt($('#file_upload_num').val()) + 1;
	$('#file_upload_num').val(file_upload_num);
	var file_chk = parseInt(<?=$file_chk?>);
	file_setting('file_fname'+file_chk, 'member', '1', '<?=$file_multi_size;?>', '');
