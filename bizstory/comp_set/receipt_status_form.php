...
// 변수
	...
	$form_chk = 'N';
	if ($auth_menu['mod'] == 'Y' && $code_idx != '') // 수정권한
	{
		$form_chk   = 'Y';
		$form_title = '수정';
	}
	...
	if ($form_chk == 'Y')
	{
		...
		$data = code_receipt_status_data("view", $where);
...
<div class="ajax_write">
	...
	<div class="ajax_frame">
		<form id="postform" name="postform" method="post" class="writeform" action="<?=$this_page;?>" onsubmit="return check_form()">
			...
			<fieldset>
				<legend class="blind">접수상태 폼</legend>
				<table class="tinytable write" summary="접수상태를 <?=$form_title;?>합니다.">
				<caption>접수상태</caption>
				<colgroup>
					<col width="100px" />
					<col />
					<col width="100px" />
				...
				<tbody>
					...
					<tr>
						<th><label for="post_code_name">접수상태명</label></th>
						<td colspan="3">
							<div class="left">
								<input type="text" name="param[code_name]" id="post_code_name" value="<?=$data['code_name'];?>" size="25" title="접수상태명을 입력하세요." class="type_text"<?=$name_style;?> readonly="readonly" />
							</div>
						</td>
					</tr>
					<tr>
