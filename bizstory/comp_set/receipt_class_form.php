...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
	if ($form_chk == 'Y')
	{
		...
		$depth_data = query_view("select max(menu_depth) as max_depth from code_receipt_class where del_yn = 'N' and comp_idx = '" . $code_comp . "' and part_idx = '" . $code_part . "' limit 1");
...
<div class="ajax_write">
	...
	<div class="ajax_frame">
		<form id="postform" name="postform" method="post" class="writeform" action="<?=$this_page;?>" onsubmit="return check_form()">
			...
			<fieldset>
				<legend class="blind">접수분류 폼</legend>
				<table class="tinytable write" summary="접수분류를 <?=$form_title;?>합니다.">
				<caption>접수분류</caption>
				<colgroup>
					<col width="120px" />
					<col />
					<col width="120px" />
