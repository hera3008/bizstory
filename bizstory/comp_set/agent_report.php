...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
// 링크, 버튼
	$link_list         = $local_dir . "/bizstory/comp_set/agent_report_list.php";      // 목록
	$link_form         = $local_dir . "/bizstory/comp_set/agent_report_form.php";      // 등록
	$link_ok           = $local_dir . "/bizstory/comp_set/agent_report_ok.php";        // 저장
	$link_excel        = $local_dir . "/bizstory/comp_set/agent_report_excel.php";     // 액셀
	$link_print        = $local_dir . "/bizstory/comp_set/agent_report_print.php";     // 인쇄
	$link_print_detail = $local_dir . "/bizstory/comp_set/agent_report_print_sel.php"; // 상세인쇄
