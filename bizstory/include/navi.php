				...
				<div id="kt_app_header" class="app-header">
					...
					<div class="app-container  container-fluid d-flex align-items-stretch justify-content-between" id="kt_app_header_container">
						...
						<div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
							<a href="<?=$local_dir;?>/bizstory/main.php" class="d-lg-none">
								<img alt="Logo" src="<?=$local_dir;?>/bizstory/assets/media/logos/default-small.svg" class="h-30px">
							</a>
						</div>
						<!--// Mobile logo -->
						<!-- Header wrapper -->
							...
							<div class="app-navbar flex-shrink-0">
                                ...
                                ?>
									...
									<div class="btn btn-icon btn-custom btn-icon-muted btn-active-light btn-active-color-primary w-30px h-30px w-md-40px h-md-40px position-relative" data-kt-menu-trigger="{default: 'click', lg: 'click'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end" id="kt_menu_item_wow">
										...
										<span class="position-absolute top-0 start-100 translate-middle  badge badge-circle badge-danger w-15px h-15px ms-n4 mt-3"><?=number_format($top_chk['receipt_ing']);?></span>
									</div>
									...
									<div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-400px" data-kt-menu="true" id="kt_menu_notifications">
										...
										<div class="d-flex flex-column bgi-no-repeat rounded-top" style="background-image:url('<?=$local_dir;?>/bizstory/assets/media/misc/menu-header-bg.jpg')">
											...
											<h3 class="text-white fw-semibold px-9 mt-10 mb-6">
												읽지 않은 알림 <span class="fs-8 opacity-75 ps-3"><?=number_format($receipt_page['total_num']);?></span>
											</h3>
											<!--// Title -->
											<!-- Tabs -->
											...
											<div class="tab-pane fade show active" id="kt_topbar_notifications_1" role="tabpanel">
                                                ...
                                                ?>
													...
													<div class="d-flex flex-stack py-2">
														...
														<div class="d-flex align-items-center me-2">
															<!-- Title -->
															<a href="javascript:void(0);" class="text-gray-800 text-hover-primary ellipsis-1" onclick="location.href='<?=$this_page;?>?fmode=receipt&smode=receipt&ri_idx=<?=$receipt_data['ri_idx'];?>'"><?=$receipt_data['subject'];?></a>
															<!--// Title -->
														</div>
														<!--// Section -->
														<!-- Label -->
                                                ...
                                                ?>
													...
													<div class="d-flex flex-stack py-2">
														...
														<div class="d-flex align-items-center me-2">
															<!-- Title -->
															<a href="javascript:void(0);" class="text-gray-800 text-hover-primary ellipsis-1">알림 내용이 없습니다.</a>
															<!--// Title -->
														</div>
														<!--// Section -->														
													</div>
											...
											<div class="tab-pane fade" id="kt_topbar_notifications_2" role="tabpanel">
												...
												<div class="scroll-y mh-250px my-4 px-8">
													...
													<div class="d-flex flex-stack py-2">
														...
														<div class="d-flex align-items-center me-2">
															<!-- Title -->
															<a href="/receipt/list.php" class="text-gray-800 text-hover-primary ellipsis-1">솔루션 납품 및 계약 총괄</a>
															<!--// Title -->
														</div>
														<!--// Section -->
														<!-- Label -->
													...
													<div class="d-flex flex-stack py-2">
														...
														<div class="d-flex align-items-center me-2">
															<!-- Title -->
															<a href="/receipt/list.php" class="text-gray-800 text-hover-primary ellipsis-1">경기도청_조직관리시스템구축사업</a>
															<!--// Title -->
														</div>
														<!--// Section -->
														<!-- Label -->
													...
													<div class="d-flex flex-stack py-2">
														...
														<div class="d-flex align-items-center me-2">
															<!-- Title -->
															<a href="/receipt/list.php" class="text-gray-800 text-hover-primary ellipsis-1">유비스토리 홈페이지 리뉴얼</a>
															<!--// Title -->
														</div>
														<!--// Section -->
														<!-- Label -->
													...
													<div class="d-flex flex-stack py-2">
														...
														<div class="d-flex align-items-center me-2">
															<!-- Title -->
															<a href="/receipt/list.php" class="text-gray-800 text-hover-primary ellipsis-1">[인증서갱신]직접생산증명서</a>
															<!--// Title -->
														</div>
														<!--// Section -->
														<!-- Label -->
													...
													<div class="d-flex flex-stack py-2">
														...
														<div class="d-flex align-items-center me-2">
															<!-- Title -->
															<a href="/receipt/list.php" class="text-gray-800 text-hover-primary ellipsis-1">홈스토리(ePlat) 리엑트 버전 개발업무</a>
															<!--// Title -->
														</div>
														<!--// Section -->
														<!-- Label -->
													...
													<div class="d-flex flex-stack py-2">
														...
														<div class="d-flex align-items-center me-2">
															<!-- Title -->
															<a href="/receipt/list.php" class="text-gray-800 text-hover-primary ellipsis-1">한국예탁결제원_전자투표 시스템 재구축</a>
															<!--// Title -->
														</div>
														<!--// Section -->
														<!-- Label -->
													...
													<div class="d-flex flex-stack py-2">
														...
														<div class="d-flex align-items-center me-2">
															<!-- Title -->
															<a href="/receipt/list.php" class="text-gray-800 text-hover-primary ellipsis-1">소프트웨어사업자 신고확인서</a>
															<!--// Title -->
														</div>
														<!--// Section -->
														<!-- Label -->
													...
													<div class="d-flex flex-stack py-2">
														...
														<div class="d-flex align-items-center me-2">
															<!-- Title -->
															<a href="/receipt/list.php" class="text-gray-800 text-hover-primary ellipsis-1">[인증서갱신]기업신용평가 신청</a>
															<!--// Title -->
														</div>
														<!--// Section -->
														<!-- Label -->
												...
												<!-- View more -->
												<div class="py-3 text-center border-top">
													<a href="/receipt/list.php" class="btn btn-color-gray-600 btn-active-color-primary">
														모두보기
														<i class="ki-duotone ki-arrow-right fs-5"><span class="path1"></span><span class="path2"></span></i>
													</a>
												</div>
										...
										<div class="card">
											...
											<div class="card-header">
												...
												<div class="card-toolbar">
													<a href="<?=$local_dir;?>/bizstory/mypage/favorites.php" class="btn btn-sm btn-icon btn-active-light-primary me-n3">
                                ...
                                ?>
									...
									<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color py-4 fs-7 w-275px" data-kt-menu="true">
										...
										<div class="menu-item px-3">
											<div class="menu-content d-flex align-items-center px-3">
												...
												<div class="symbol symbol-50px me-5">
													<img alt="Logo" src="<?=$mem_img['img_26'];?>">
												</div>
												<!--// Avatar -->
												<!-- Username -->
												<div class="d-flex flex-column">
													<div class="fw-semibold d-flex align-items-center fs-5">
                                                        <?=$code_mem_name;?> <span class="badge badge-light-danger fs-8 px-2 py-1 ms-2">Admin</span>
													</div>
													<a href="javascript:void(0);" class="text-muted text-hover-primary fs-8 kt_user_button">
                                                        <?=$member_data['mem_email1'];?>
													</a>
												</div>
												<!--// Username -->
											</div>
										...
										<div class="menu-item px-5">
											<a href="javascript:void(0);" onclick="location.href='/index.php?fmode=myinfo&smode=myinfo'" class="menu-link px-5">
												정보수정
											</a>
										</div>
										<!--// Menu item -->
										...
										<!-- Menu item -->
										<div class="menu-item px-5">
											<a href="javascript:void(0);" onclick="location.href='/index.php?fmode=receipt&smode=receipt'" class="menu-link px-5">
												접수목록
											</a>
										</div>
										<!--// Menu item -->
