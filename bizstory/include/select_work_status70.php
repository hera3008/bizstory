...
<div class="pstatus_box">
	...
	<form id="status70form" name="status70form" action="<?=$this_page;?>" method="post">
		...
		<input type="hidden" id="status70_wi_idx"   name="wi_idx"   value="<?=$wi_idx;?>" />
		...
		<div class="pstatus">
			...
			<div class="pstatus_wrap">
				<div class="pstatus_data">
					<div class="user_edit">
						업무를 반려하면, 해당 업무의 담당자에게 반려사유를 알려드립니다.
					</div>
				</div>
			</div>
