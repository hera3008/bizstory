...
플리킹 이동을 이 위치만큼 이동하게 수정가능한 옵션
    ...
    **/
    $init : function(sId, htUserOption){
     ...
     $static : {
        _htAnimation : {
            'circular-slide' : '_SlideFlicking_',
            'slide' : '_SlideFlicking_',
            'cover' : '_CoverFlicking_',
    ...
    **/
    isAnimating : function(){
        if(this._oFlickingAnimation){
            return this._oFlickingAnimation._doFlicking;
        }
    },
    ...
    **/
    _detachEvent : function() {
       ...
       for(var p in this._htEvent){
        ...
        if(this._oFlickingAnimation){
            this._oFlickingAnimation.detachAll();
            // this._oFlickingAnimation.deactivate();
        }
