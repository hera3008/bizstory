...
?>
		<li class="barmenu">
			<a href="javascript:void(0)" onclick="window.location.href='<?=$mobile_dir;?>/receipt_view.php?ri_idx=<?=$data['ri_idx'];?>'" class="loop">
...
?>
		<li class="barmenu">
			<a href="javascript:void(0)" onclick="window.location.href='<?=$mobile_dir;?>/work_my_view.php?wi_idx=<?=$data['wi_idx'];?>'" class="loop">
...
?>
		<li class="barmenu ajax<?=$morenum;?>">
			<a href="javascript:void(0)" onclick="window.location.href='<?=$mobile_dir;?>/message_view.php?mr_idx=<?=$data['mr_idx'];?>'" class="loop">
