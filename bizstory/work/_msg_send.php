...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
// 링크, 버튼
	$link_list = $local_dir . "/bizstory/work/msg_send_list.php"; // 목록
	$link_form = $local_dir . "/bizstory/work/msg_form.php";      // 등록
	$link_view = $local_dir . "/bizstory/work/msg_send_view.php"; // 보기
...
//------------------------------------ 삭제하기
	function check_send_delete(idx)
	{
		if (confirm("선택하신 쪽지를 삭제하시겠습니까?"))
		{
			view_close();
			check_code_data('delete_send', '', idx, '');
		}
	}
