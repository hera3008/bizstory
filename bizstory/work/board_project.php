...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
// 링크, 버튼
	$link_list         = $local_dir . "/bizstory/work/board_project_list.php";      // 목록
	$link_form         = $local_dir . "/bizstory/work/board_project_form.php";      // 등록
	$link_view         = $local_dir . "/bizstory/work/board_project_view.php";      // 보기
	$link_ok           = $local_dir . "/bizstory/work/board_project_ok.php";        // 저장
	$link_excel        = $local_dir . "/bizstory/work/board_project_excel.php";     // 액셀
	$link_print        = $local_dir . "/bizstory/work/board_project_print.php";     // 인쇄
	$link_print_detail = $local_dir . "/bizstory/work/board_project_print_sel.php"; // 상세인쇄
...
?>
	<div id="tableheader">
		...
		<form id="searchform" name="searchform" method="post" action="<?=$this_page;?>" onsubmit="return check_search();">
			...
			<div class="search">
				<p>검&nbsp;&nbsp;&nbsp;색</p>
				<select id="search_sclient" name="sclient" title="전체거래처">
...
<?
	...
	{
		include $local_path . "/bizstory/work/board_project_form.php";
	}
?>
</div>
...
//------------------------------------ 검색
	function check_search()
	{
		...
		document.listform.sclient.value = $('#search_sclient').val(); // 거래처명
