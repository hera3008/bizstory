				...
				<tr>
					...
					<td>
						<div class="left">
							...
							<span class="field_help">* 프로젝트코드가 없을 경우 자동으로 생성이 됩니다.</span>
						</div>
					</td>
				</tr>
				<tr>
...
?>
	...
	$("#part_charge_btn_<?=$code_part;?>").html(" - ");
	$("#part_charge_view_<?=$code_part;?>").css({"display": "block"});
