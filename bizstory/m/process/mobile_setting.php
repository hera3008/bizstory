...
// 일반페이지관련
	...
	$mobile_dir  = $local_dir . '/bizstory/m';
...
/* 상단 기타버튼 */
	...
	$btn_logout = '<p class="logout"><a href="javascript:" onclick="login_out2();login_out();"><img src="./images/ico_logoutx2.png" alt="로그아웃" id="logoutBtn" height="18px"></a></p>';
