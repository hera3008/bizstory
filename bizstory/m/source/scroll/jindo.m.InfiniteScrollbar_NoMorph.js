...
jindo.m.InfiniteScrollbar = jindo.$Class({
  ...
  **/
  ...
  _updaterProcess : function() {
    if(this._nBeforeX != this._oAnimation._nX || this._nBeforeY != this._oAnimation._nY) {
      // console.error("update");
      this._oAnimation.setPos(this._oAnimation._nX, this._oAnimation._nY);
      this._nBeforeX = this._oAnimation._nX;
      this._nBeforeY = this._oAnimation._nY;
    }
    // console.log(this._oAnimation._nX, this._oAnimation._nY);
