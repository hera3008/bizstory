//<![CDATA[
	...
	function pullDownAction ()
	{
		...
		// 데이타 출력
			$.ajax({
				async : false,
				type: "get", dataType: 'html', url: '/bizstory/m/process/ajax_list.php',
...
//------------------------------------ 접수 - 상태변경
	...
	{
		$.ajax({
			type: "post", dataType: 'html', url: '/bizstory/m/receipt_view_section.php',
...
//------------------------------------ 접수상태변경
	function receipt_change_endok(idx)
	{
		...
		if (action_num == 0)
		{
			...
			$.ajax({
				async : false,
				type: 'post', dataType: 'json', url: '/bizstory/m/receipt_ok.php',
				data: $('#viewform').serialize(),
				success : function(msg) {
...
//------------------------------------ 접수 - 상태이력
	function receipt_history()
	{
		$.ajax({
			async : false,
			type: "post", dataType: 'html', url: '/bizstory/m/receipt_stauts_history.php',
			data: $('#viewform').serialize(),
			success: function(msg) {
...
//------------------------------------ 접수 - 코멘트
	function receipt_comment()
	{
		$.ajax({
			async : false,
			type: "get", dataType: 'html', url: '/bizstory/m/receipt_view_comment_list.php',
...
//------------------------------------ 접수 - 코멘트 등록
	function receipt_comment_insert(form_type)
	{
		...
		else
		{
			$.ajax({
				async : false,
				type: "post", dataType: 'html', url: '/bizstory/m/receipt_view_comment_form.php',
				data: $('#viewform').serialize(),
				success: function(msg) {
...
//------------------------------------ 접수 - 코멘트 등록실행
	function receipt_comment_check()
	{
		...
		if (action_num == 0)
		{
			$.ajax({
				async : false,
				type: "post", dataType: 'json', url: '/bizstory/m/receipt_view_comment_ok.php',
...
//------------------------------------ 업무보고서 목록
	...
	{
		$.ajax({
			type: "get", dataType: 'html', url: '/bizstory/m/work_my_view_report_list.php',
...
//------------------------------------ 업무보고서 등록
	function report_insert_form(form_type)
	{
		...
		{
			$.ajax({
				type: "post", dataType: 'html', url: '/bizstory/m/work_my_view_report_form.php',
				data: $('#viewform').serialize(),
				success: function(msg) {
...
//------------------------------------ 댓글 목록
	...
	{
		$.ajax({
			type: "get", dataType: 'html', url: '/bizstory/m/work_my_view_comment_list.php',
			data: $('#commentlistform').serialize(),
			success: function(msg) {
				$('#comment_list_data').html(msg);
				myScroll.refresh();
...
//------------------------------------ 댓글 등록
	function comment_insert_form(form_type)
	{
		...
		{
			$.ajax({
				type: "post", dataType: 'html', url: '/bizstory/m/work_my_view_comment_form.php',
				data: $('#viewform').serialize(),
				success: function(msg) {
					$('#comment_new_btn').css({'display':'none'});
					$("#new_comment").html(msg);
...
//------------------------------------ 상담 - 코멘트
	function consult_comment()
	{
		$.ajax({
			async : false,
			type: "get", dataType: 'html', url: '/bizstory/m/consult_view_comment_list.php',
			data: $('#commentlistform').serialize(),
			success: function(msg) {
				$('#comment_list_data').html(msg);
				myScroll.refresh();
...
//------------------------------------ 상담 - 코멘트 등록
	function consult_comment_insert(form_type)
	{
		...
		else
		{
			$.ajax({
				async : false,
				type: "post", dataType: 'html', url: '/bizstory/m/consult_view_comment_form.php',
				data: $('#viewform').serialize(),
				success: function(msg) {
					$('#comment_new_btn').css({'display':'none'});
					$("#new_comment").html(msg);
...
//------------------------------------ 상담 - 코멘트 등록실행
	function consult_comment_check()
	{
		...
		if (action_num == 0)
		{
			$.ajax({
				async : false,
				type: "post", dataType: 'json', url: '/bizstory/m/consult_view_comment_ok.php',
				data: $('#commentform').serialize(),
				success: function(msg) {
					if (msg.success_chk == "Y")
					{
