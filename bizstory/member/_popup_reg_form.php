...
<div class="ajax_write">
	<div class="ajax_frame">
		...
		<form id="popup_joinform" name="popup_joinform" class="joinform" method="post" action="<?=$this_page;?>">
		...
		<fieldset>
			...
			<tbody>
				<tr>
					<td colspan="4">
						<div class="agreement" title="이용약관">
							<?=$use_rule;?>
						</div>
						<div class="left">
							<label for="agree_check" class="fr">
								<input type="checkbox" name="agree_check" id="agree_check" title="약관에 동의해 주셔야만 회원가입을 하실 수 있습니다." />
					...
					<td colspan="4">
						<div class="left">
							<strong style="color:#ff0000;">
								* 등록한 이메일이 로그인 메일주소가 됩니다.<br />
								* 전화번호 맨뒷자리 4자리가 비밀번호가 됩니다. 전화번호를 꼭 기입해주세요.<br />
							</strong>
						</div>
					</td>
				</tr>
			...
			<div class="section">
				<div class="fr">
					<strong class="btn_sml" onclick="check_regist();"><span>서비스신청</span></strong>
					<strong class="btn_sml" onclick="popupform_close();"><span>신청취소</span></strong>
				</div>
			</div>
		</fieldset>
		</form>
