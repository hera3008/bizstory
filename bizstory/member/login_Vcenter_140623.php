...
<link href="<?=$local_dir;?>/bizstory/images/vcenter/favicon.ico" rel="icon" type="image/ico" />
<link href="<?=$local_dir;?>/bizstory/images/vcenter/favicon.png" rel="icon" type="image/png" />
<link href="<?=$local_dir;?>/bizstory/images/vcenter/favicon.ico" rel="shortcut icon" type="image/ico" />

<link type="text/css" rel="stylesheet" href="<?=$local_dir;?>/bizstory/css/vcenter.css" media="all" />
<title>V-Center Login</title>
</head>
...
<body id="login_layout">
	...
	<div id="header">
		<a href="javascript:void(0)" onclick="location.href='<?=$local_dir;?>/'" title="홈으로 이동 합니다." class="logo">
			<img src="<?=$local_dir;?>/bizstory/images/vcenter/logo_vcenter.jpg" width="198px" height="39px" alt="home" />
		</a>
				...
				<div id="login_frame">
						...
						<div class="sliderkit gall-img">
							<div class="sliderkit-nav">
								<div class="sliderkit-nav-clip">
									<ul>
										<li>
											<img src="/bizstory/images/vcenter/vcenter_img.png" alt="" />
										</li>
										<li>
											<img src="/bizstory/images/vcenter/vcenter_img2.png" alt="" />
										</li>
										<li>
											<img src="/bizstory/images/vcenter/vcenter_img3.png" alt="" />
										</li>
									</ul>
								</div>
					...
					?>
						<div id="login_banner" class="ad_banner">
							<div id="ad_banner">
								<img src="/bizstory/images/vcenter/banner01.gif" alt="v-center simtos 2014에 참가합니다. 2014년 4월 9일(수)~13일(일) Kintex"  />
							</div>
					...
					?>
						...
						<div id="service_counter">
							<a href="http://www.gunsol.com/" target="_blank" title="새창으로 이동"><img src="/bizstory/images/vcenter/gunsolution_logo.png" alt="건솔루션" /></a>
						</div>
