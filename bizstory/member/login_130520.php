			...
			<td id="container">
				...
				<div id="login_frame">
					<div class="login_box">
						...
						<div class="login_app">
							<ul>
								<li><a href="market://details?id=com.ubstory.bizstory" target="_blank" title="새창으로 이동"><img src="<?=$local_dir;?>/bizstory/images/common/android_qr.png" alt="안드로이드 app" /></a></li>
