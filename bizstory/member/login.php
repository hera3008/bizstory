			...
			<div class="sliderkit gall-img">
				<div class="sliderkit-nav">
					<div class="sliderkit-nav-clip">
						<ul>
							<li>
								<a href="http://www.ubstory.net/bbs/boardView.do?id=9&bIdx=11&page=1&menuId=56" target="_blank" title="새창으로 이동"><img src="/bizstory/images/common/popup_podcast3.jpg" alt="" /></a>
							</li>
							<li>
								<a href="http://www.ubstory.net/bbs/boardView.do?id=9&bIdx=24&page=1&menuId=56" target="_blank" title="새창으로 이동"><img src="/bizstory/images/common/popup_tv_asiae.jpg" alt="" /></a>
							</li>
							<li>
							...
							<li>
								<a href="http://viewstory.ubstory.net" target="_blank" title="새창으로 이동"><img src="/bizstory/images/common/popup_viewstory.jpg" alt="" /></a>
							</li>
						</ul>
					</div>
				...
				<div class="tab_board board1">
					...
					<div>
						<ul style="display: block;">
							<li>
								<dl>
									<dt><a href="http://www.ubstory.net/bbs/boardView.do?id=9&bIdx=11&page=1&menuId=56" target="_blank" title="새창으로 이동">비즈스토리/홈스토리 팟캐스트 광고를 시작합니다.</a></dt>
									<dd>
										<div><img width="360" src="http://www.ubstory.net/ubstory/include/img/ad/ad_conference.jpg" alt="" /></div>
										비즈스토리/홈스토리를 어떻게 고객들에게 쉽고 명쾌하게 전달할 것인가에 대한 다양한 아이디어를 모아모아 스팟광고의 결실을 만들어냈습니다.<br />삼시두끼,불금쇼2 특유의 유머로 탄생한 ‘비즈스토리/홈스토리’~!!<br />즐겁게 광고를 들어보시고 평가해주시면 더욱 나은 광고로 보답하겠습니다.
									</dd>
								</dl>
							</li>
...
<!-- 			<address>
            ...
            <address>
                <p>(주)유비스토리 &nbsp;&nbsp; 대표이사 서경원 &nbsp;&nbsp; 사업자등록번호 123-86-22903</p>
                <p>(14067) 경기도 안양시 동안구 시민대로248번길 25 (부림동 1591-9) 안양창조산업진흥원 305호 &nbsp;&nbsp; T. 1544-7325 &nbsp;&nbsp; E. ubsns@ubstory.net</p>
            </address>
		</div>
		<div id="footer"></div>
	</div>
