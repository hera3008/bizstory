		...
		<fieldset>
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<div class="left">
							<input type="text" name="param[tel_num]" id="post_tel_num" class="type_text" title="전화번호를 입력하세요." size="15" value="<?=$data['tel_num'];?>" />
						</div>
					</td>
				</tr>
				<tr>
			...
			?>
									<li id="file_fname_<?=$file_chk;?>_liview" class="org_file">
										...
										<a href="javascript:void(0);" class="btn_con" onclick="file_multi_form_delete('<?=$file_data['rf_idx'];?>', '<?=$file_chk;?>')"><span>삭제</span></a>
									</li>
			<?
					}
				}
