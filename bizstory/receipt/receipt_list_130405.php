...
<div class="details">
	...
	<div class="etc_bottom">
		...
		<?=$btn_print_sel;?>
		<?=$btn_write;?>
		<a href="javascript:void(0);" onclick="list_search('my_no')" class="btn_big"><span>나의 미처리</span></a>
		<a href="javascript:void(0);" onclick="list_search('all_no')" class="btn_big"><span>전체 미처리</span></a>
		<a href="javascript:void(0);" onclick="list_search('all')" class="btn_big"><span>전체목록</span></a>
	</div>
</div>
<hr />
...
?>
	...
	?>
			...
			<td>
				<a href="javascript:void(0)" class="member_info_view"><?=$list_data['member_str'];?></a>
			</td>
			<td>
				<span class="num"><?=date_replace($list_data['reg_date'], 'Y.m.d');?><?=$list_data['end_date_str'];?></span>
			</td>
			<td>
				<!--//<a href="javascript:void(0);" onclick="client_receipt_move('<?=$list_data['ci_idx'];?>')"><img src="bizstory/images/icon/receipt.gif" alt="접수페이지로 이동합니다." /></a>//-->
				<?=$list_data['link_html'];?>
			</td>
		</tr>
<?
