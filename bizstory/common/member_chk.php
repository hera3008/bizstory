<?
	If ($_SESSION[$sess_str . "_mem_idx"] == "")
	{
		...
		$domain_where = " and di.domain = '" . $site_url1 . "'";
	...
	// 권한체크
		...
		else
		{
			...
			if ($_SESSION[$sess_str . "_comp_idx"] == '1' && ($mem_idx == '2' || $mem_idx == '8' || $mem_idx == '195' || $mem_idx == '15' || $mem_idx == '14'))
			{
				$auth_menu['list']  = "Y";
				$auth_menu['view']  = "Y";
				$auth_menu['int']   = "Y";
				...
				$bbs_auth_yn = 'Y';
			} else if ($_SESSION[$sess_str . "_ubstory_level"] <= 11 && $_SESSION[$sess_str . '_ubstory_yn'] == 'Y') {
			    $auth_menu['list']  = "Y";
                $auth_menu['view']  = "Y";
                $auth_menu['int']   = "Y";
                $auth_menu['mod']   = "Y";
