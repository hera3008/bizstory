...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
	if ($form_chk == 'Y')
	{
		...
		$data = code_account_gubun_data("view", $where);
...
<div class="ajax_write">
	...
	<div class="ajax_frame">
		<form id="postform" name="postform" method="post" class="writeform" action="<?=$this_page;?>" onsubmit="return check_form()">
			...
			<fieldset>
				<legend class="blind">회계구분 폼</legend>
				<table class="tinytable write" summary="회계구분를 <?=$form_title;?>합니다.">
				<caption>회계구분</caption>
				<colgroup>
					<col width="120px" />
					<col />
					<col width="120px" />
				...
				<tbody>
					...
					<tr>
						<th><label for="post_code_name">회계구분명</label></th>
						<td colspan="3">
							<div class="left">
					<?
						if ($data['set_yn'] == 'Y')
						{
							echo '<span', $name_style, '>', $data["code_name"], '</span>';
						}
						else
						{
					?>
								<input type="text" name="param[code_name]" id="post_code_name" value="<?=$data['code_name'];?>" size="25" title="회계구분명을 입력하세요." class="type_text"<?=$name_style;?> />
					<?
						}
					?>
							</div>
