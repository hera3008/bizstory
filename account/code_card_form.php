...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
	if ($form_chk == 'Y')
	{
		...
		$data = code_account_card_data("view", $where);
		...
		if ($data["card_gubun"] == '') $data["card_gubun"] = '1';
...
<div class="ajax_write">
	...
	<div class="ajax_frame">
		<form id="postform" name="postform" method="post" class="writeform" action="<?=$this_page;?>" onsubmit="return check_form()">
			...
			<fieldset>
				<legend class="blind">카드관리 폼</legend>
				<table class="tinytable write" summary="카드관리를 등록/수정합니다.">
				<caption>카드관리</caption>
				<colgroup>
					<col width="120px" />
					<col />
					<col width="120px" />
				...
				<tbody>
					...
					<tr>
						...
						<td colspan="3">
							<div class="left">
								<?=code_radio($set_card_gubun, "param[card_gubun]", "post_card_gubun", $data["card_gubun"], '카드구분을 선택하세요.');?>
							</div>
						</td>
					</tr>
					<tr>
						<th><label for="post_code_name">카드명</label></th>
						<td>
							<div class="left">
						...
						<th><label for="post_card_num">카드번호</label></th>
						<td>
							<div class="left">
								<input type="text" name="param[card_num]" id="post_card_num" value="<?=$data['card_num'];?>" size="25" title="계좌번호를 입력하세요." class="type_text" />
							</div>
						</td>
					</tr>
					<tr>
						...
						<td colspan="3">
							<div class="left">
								<select name="param[mem_idx]" id="post_mem_idx" title="사용직원을 선택하세요">
									<option value="">사용직원을 선택하세요</option>
								</select>
							</div>
						</td>
					</tr>
				...
				?>
						...
						<span class="btn_big_blue"><input type="button" value="취소" onclick="popupform_close()" /></span>
