...
//기초값 검사
	...
	{
	//필수검사
		$chk_param['require'][] = array("field"=>"code_name", "msg"=>"구분명");
...
// 등록 함수
	...
	// 기본값설정
		if ($param['default_yn'] == 'Y')
		{
			...
			$page_data = code_account_gubun_data("page", $where);
...
//위 정렬 함수
	function sort_up()
	{
		...
		$prev_data = code_account_gubun_data('view', $sort_where, $sort_order);
...
//아래 정렬 함수
	function sort_down()
	{
		...
		$next_data = code_account_gubun_data('view', $sort_where, $sort_order);
