...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
// 링크, 버튼
	$link_list = $local_dir . "/bizstory/account/code_bank_list.php"; // 목록
	$link_form = $local_dir . "/bizstory/account/code_bank_form.php"; // 등록
	$link_ok   = $local_dir . "/bizstory/account/code_bank_ok.php";   // 저장
?>
...
//------------------------------------ 등록
	function check_form()
	{
		...
		chk_value = $('#post_bank_num').val();
		chk_title = $('#post_bank_num').attr('title');
		if (chk_value == '')
		{
			chk_total = chk_total + chk_title + '<br />';
			action_num++;
