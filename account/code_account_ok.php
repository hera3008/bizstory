...
//기초값 검사
	...
	{
	//필수검사
		$chk_param['require'][] = array("field"=>"code_name", "msg"=>"계정과목");
...
// 등록 함수
	...
	// 기본값설정
		if ($param['default_yn'] == 'Y')
		{
			...
			$page_data = code_account_class_data("page", $where);
...
// 수정 함수
	...
	// 변경전의 데이타를 가지고 온다.
		...
		$old_data = code_account_class_data("view", $where);
...
////////////////////////////////////////////////////////////////////////////////////////////////////////
	// 상위가 다를경우
		...
		// 자기 하위것들 같이 움직이기
			...
			$down_list = code_account_class_data("list", $where, "", "", "");
...
//위 정렬 함수
	function sort_up()
	{
		...
		$prev_data = code_account_class_data('view', $sort_where, $sort_order);
...
//아래 정렬 함수
	function sort_down()
	{
		...
		$next_data = code_account_class_data('view', $sort_where, $sort_order);
