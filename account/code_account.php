...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
// 링크, 버튼
	$link_list  = $local_dir . "/bizstory/account/code_account_list.php";  // 목록
	$link_form  = $local_dir . "/bizstory/account/code_account_form.php";  // 등록
	$link_ok    = $local_dir . "/bizstory/account/code_account_ok.php";    // 저장
	$link_up    = $local_dir . "/bizstory/account/code_account_up.php";    // 상위
	$link_excel = $local_dir . "/bizstory/account/code_account_excel.php"; // 액셀
?>
