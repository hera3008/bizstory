...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	{
		$btn_write = '<a href="javascript:void(0);" class="btn_big_green" onclick="popupform_open(\'\')"><span>등록</span></a>';
	}

	if ($auth_menu['down'] == "Y") // 다운로드버튼
	{
		$btn_down = '<a href="javascript:void(0);" class="btn_big_violet" onclick="excel_data()"><span>엑셀</span></a>';
	}
?>
...
<table class="tinytable">
	...
	<thead>
		<tr>
			...
			<th class="nosort"><h3>계정과목코드</h3></th>
	...
	else
	{
		...
		foreach($list as $k => $data)
		{
			if (is_array($data))
			{
				...
				$sort_data = query_view("select min(sort) as min_sort, max(sort) as max_sort from code_account_class where del_yn = 'N' and comp_idx ='" . $code_comp . "' and part_idx ='" . $code_part . "' and up_code_idx = '" . $data["up_code_idx"] . "'");
