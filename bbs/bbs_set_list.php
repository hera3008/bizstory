...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
// 페이지관련
	$list = bbs_setting_data('list', $where, '', $page_num, $page_size);
...
<?
	...
	else
	{
		...
		foreach($list as $k => $data)
		{
			...
			{
				$bs_idx   = $data['bs_idx'];
				$url_cate = $local_dir . '/bizstory/bbs/bbs_cate.php';
			...
			// 게시물수
				...
				$sub_data = bbs_info_data('page', $sub_where);
...
?>
		...
		?>
			...
			<td>
				<a href="<?=$local_dir;?>/index.php?fmode=bbs&amp;smode=bbs&amp;bs_idx=<?=$data["bs_idx"];?>" class="btn_con_violet"><span>보기</span></a>
