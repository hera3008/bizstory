...
// 업체정보
	...
	else
	{
		...
		$comp_data = company_info_data('view', $comp_where, '', '', '', 2);

		$bizstory_view = "N";
		$error_string  = '
			<strong style="color:#ff6c00"> 브라우저 오류 및 서비스 사용이 중지 되었습니다.</strong><br /><br />
			<strong>[연락처 : ' . $comp_data['tel_num'] . ']</strong><br />';
	}
?>