...
<title>BizStory Agent(C Type) - <?=$client_name;?></title>
...
?>
			<!-- ___Ticker -->
			<div class="demo">
				<marquee behavior="scroll" direction="left" scrollamount="2" width="400"><p>
<?
...
?>
					<span class="maintain_notice" style="padding-right:20px;">ㆍ [Bizstory] <?=$content;?><?=$important_span;?></span>
<?
		}
	}
