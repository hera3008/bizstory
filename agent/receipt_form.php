		...
		<fieldset>
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<div class="left">
							<input type="text" name="param[tel_num]" id="post_tel_num" class="type_text" title="전화번호를 입력하세요." size="20" value="<?=$data['tel_num'];?>" />&nbsp;<span style="color:#ee6666">개인정보 유출방지를 위해 개인 휴대폰 번호는 가급적 삼가해주시고 사무실번호 또는 위치정보(예:00시청 00과)형태로 입력해 주시기바랍니다.</span>
						</div>
					</td>
				</tr>
				<tr>
