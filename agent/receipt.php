...
<?
	...
	{
		if ($receipt_idx != '') $ri_idx = $receipt_idx;
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////
	// 링크, 버튼
		$link_list         = $local_dir . "/agent/receipt_list.php";      // 목록
		$link_form         = $local_dir . "/agent/receipt_form.php";      // 등록
		$link_view         = $local_dir . "/agent/receipt_view.php";      // 보기
		$link_ok           = $local_dir . "/agent/receipt_ok.php";        // 저장
		$link_excel        = $local_dir . "/agent/receipt_excel.php";     // 액셀
		$link_print        = $local_dir . "/agent/receipt_print.php";     // 인쇄
		$link_print_detail = $local_dir . "/agent/receipt_print_sel.php"; // 상세인쇄
...
?>
	...
	<?
		...
		else if ($sub_type == 'postform' || $sub_type == 'modifyform')
		{
			...
			include $local_path . "/agent/receipt_form.php";
			echo '</div>';
		}
	?>
		</div>

<script type="text/javascript" src="<?=$local_dir;?>/bizstory/js/script_comment.js"></script>
