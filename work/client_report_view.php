...
?>
		...
		<tr>
			...
			<td class="b_trl" height="25px" colspan="26"><?=$data['client_address'];?></td>
		</tr>
	<?
	...
	?>
		<tr>
			...
			<td class="b_trl left" height="25px" colspan="13"><?=$data['report_charge'];?></td>
		</tr>
		<tr>
	...
	<br />
	<span class="btn_big_gray"><input type="button" value="닫기" onclick="window.close()" /></span>
	<br /><br />
</body>
</html>
<?
