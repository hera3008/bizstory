...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
// 링크, 버튼
	$link_list         = $local_dir . "/bizstory/work/staff_list.php";      // 목록
	$link_view         = $local_dir . "/bizstory/work/staff_view.php";      // 보기
	$link_excel        = $local_dir . "/bizstory/work/staff_excel.php";     // 액셀
	$link_print        = $local_dir . "/bizstory/work/staff_print.php";     // 인쇄
	$link_print_detail = $local_dir . "/bizstory/work/staff_print_sel.php"; // 상세인쇄
...
<div class="tablewrapper">
	<div id="tableheader">
		...
		<form id="searchform" name="searchform" method="post" action="<?=$this_page;?>" onsubmit="return check_search();">
			...
			<div class="search">
				<p>검&nbsp;&nbsp;&nbsp;색</p>
				<select name="shgroup" id="search_shgroup" title="전체직원그룹">
