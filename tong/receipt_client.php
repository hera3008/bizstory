...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
// 링크, 버튼
	$link_list = $local_dir . "/bizstory/tong/receipt_client_list.php"; // 목록
?>
<div class="tablewrapper">
	...
	<div id="tableheader">
		...
		<? include $local_path . "/bizstory/comp_set/client_menu_inc.php"; ?>
	...
	<form id="listform" name="listform" method="post" action="<?=$this_page;?>">
		...
		<input type="hidden" id="list_code_client"  name="code_client"  value="<?=$code_client;?>" />
...
<script>
	function check_ci_idxs() {
		//$('#ci_idxs option:selected').each(function() {
	...
	function move_client(client_idx)
	{
		$('#list_code_client').val(client_idx);
		$('#client_menu a').removeClass('select');
		$('#client_' + client_idx).addClass('select');
...
//------------------------------------ 검색
	function check_search(list_type)
	{
		...
		$('#list_code_client').val(getSelectedOptions('ci_idxs'));
	...
	function down_excel(list_type) {
		...
		form.target = "_blank";
		form.action = "./bizstory/tong/receipt_client_excel.php";
		form.submit();
		return false;
	}
