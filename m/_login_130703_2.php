				...
				<article class="login_section">
					...
					<div class="login_area">
						<section>
							...
							<!-- div class="ubtn">
								<p class="float_l"><input type="checkbox" name="login_auto_check" id="login_auto_check" tabindex="3" title="자동로그인"  checked="checked"  />자동로그인</p>
							...
							<!-- div class="switc_area">
								<div class="float_l">
									<div class="switchL float_l">
										<input type="checkbox" value="None" id="switchL" name="check" checked="checked" />
										<label for="switchL"><i></i></label>
									</div>
									<strong>자동로그인</strong>
								</div>
								<div class="float_r">
