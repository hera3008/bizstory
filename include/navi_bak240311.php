						...
						<div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
							<a href="javascript:void(0);" onclick="location.href='<?=$local_dir;?>/'" title="홈으로 이동 합니다." class="d-lg-none">
								...
								// 총판로고
									...
									{
										$sole_logo_img = $local_dir . '/bizstory/assets/media/logos/default-small.svg';
									}
									else
									{
										...
										{}
										else $sole_logo_img = $local_dir . '/bizstory/assets/media/logos/default-small.svg';
									}
								?>
								<img src="<?=$sole_logo_img ?>" alt="BI" class="h-30px"/>
							</a>
						</div>
						<!--// Mobile logo -->
						<!-- Header wrapper -->
