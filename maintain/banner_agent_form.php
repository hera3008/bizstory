...
/*
	생성 : 2012.05.24
	수정 : 2013.05.22
	위치 : 설정폴더(총관리자용) > 컨텐츠관리 > 배너관리 > 에이전트배너 - 등록/수정
*/
...
<div class="info_text">
	<ul>
		...
		<li>파일크기 : 373 * 100이고, 이미지파일만 가능합니다.</li>
	</ul>
</div>
				...
				<table class="tinytable write" summary="배너를 등록/수정합니다.">
					...
					<?
						if ($data['img_sname1'] != '')
						{
							...
							$img_str = '<img src="' . $banner_dir . '/' . $data['img_sname1'] . '" width="373px" height="100px" alt="' . $data['img_fname1'] . '" />';
					?>
										<?=$img_str;?>
...
<script type="text/javascript">
//<![CDATA[
	file_setting('file_fname1', 'agent_banner', '1', '<?=$file_multi_size;?>', '');
