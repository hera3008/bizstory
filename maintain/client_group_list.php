...
// 변수
    ...
    $where = " and ccg.del_yn = 'N' " . (!$comp_idx && !$part_idx ? " and ccg.import_yn = 'Y'":"");
    $where = $where .($comp_idx ? " and ccg.comp_idx = '" . $code_comp . "'" : "");
    $where = $where .($part_idx ? " and ccg.part_idx = '" . $code_part . "'" : "");
                                                    ...
                                                    else
                                                    {
                                                        ...
                                                        foreach($list as $k => $data)
                                                        {
                                                            if (is_array($data))
                                                            {
                                                                ...
                                                                if ($auth_menu['del'] == "Y" && $data["import_yn"] == 'Y') $btn_delete = "check_delete('" . $ccg_idx . "')";
                                                ...
                                                ?>
                                                            <tr>
																...
																<td>
																	...
																	<?if($data['menu_num'] == 0 && $data["import_yn"] == 'Y'){?>
