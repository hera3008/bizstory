...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
// 링크, 버튼
	$link_list = $local_dir . "/bizstory/maintain/push_registration_list.php"; // 목록
	$link_ok   = $local_dir . "/bizstory/maintain/push_registration_ok.php";   // 저장
		...
		<form id="searchform" name="searchform" method="post" action="<?=$this_page;?>" onsubmit="return check_search();">
			...
			<div class="search">
				<select id="search_swhere" name="swhere" title="<?=$search_column;?>">
					...
					<option value="push.push_registration_id"<?=selected($swhere, 'push.push_registration_id');?>>등록ID</option>
					<option value="push.push_device_unique_id"<?=selected($swhere, 'push.push_device_unique_id');?>>디바이스번호</option>
				</select>
