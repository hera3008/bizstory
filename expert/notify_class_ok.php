...
// 등록 함수
	...
	// 기본값설정
		if ($param['default_yn'] == 'Y')
		{
			...
			$page_data = expert_code_notify_class_data("page", $where);
	...
	// 등록
		$command    = "insert"; //명령어
		$table      = "expert_code_notify_class"; //테이블명
		$conditions = ""; //조건
...
//위 정렬 함수
	function sort_up()
	{
		...
		$prev_data = expert_code_notify_class_data('view', $sort_where, $sort_order);
...
//아래 정렬 함수
	function sort_down()
	{
		...
		$next_data = expert_code_notify_class_data('view', $sort_where, $sort_order);
