...
// 변수
	...
	// 코멘트
		...
		$comment_page = comp_bbs_comment_data('page', $comment_where);
					...
					<?
							foreach ($file_list as $file_k => $file_data)
							{
								if (is_array($file_data))
								{
									...
									$btn_str = preview_file($bbs_dir, $file_data['bf_idx'], 'comp_bbs');
					?>
									<li>
										<?=$btn_str;?>
										<a href="<?=$local_diir;?>/bizstory/maintain_bbs/bbs_download.php?bf_idx=<?=$file_data['bf_idx'];?>" title="<?=$file_data['img_fname'];?> 다운로드" class="fileicon"><?=$file_data['img_fname'];?> (<?=$fsize;?>)</a>
									</li>
					<?
								}
							}
							$btn_img = preview_images($b_idx, 'comp_bbs');
							if ($btn_img != '')
							{
								echo '
									<li>' . $btn_img . '</li>
...
//<![CDATA[
//------------------------------------ 댓글 관련
	var comment_list = '<?=$local_dir;?>/bizstory/maintain_bbs/bbs_view_comment_list.php';
	var comment_form = '<?=$local_dir;?>/bizstory/maintain_bbs/bbs_view_comment_form.php';
	var comment_ok   = '<?=$local_dir;?>/bizstory/maintain_bbs/bbs_view_comment_ok.php';
