...
// 등록 함수
	...
	// 등록
		...
		$data = query_view("
			...
			from " . $table . "
			where del_yn = 'N' and bs_idx = '" . $bs_idx . "'");
...
//위 정렬 함수
	function sort_up()
	{
		...
		$data = comp_bbs_category_data('view', $where);

		$sort_where = " and bc.bs_idx = '" . $bs_idx . "' and bc.sort < '" . $data["sort"] . "'";
		$sort_order = "bc.sort desc";
		$prev_data = comp_bbs_category_data('view', $sort_where, $sort_order);
...
//아래 정렬 함수
	function sort_down()
	{
		...
		$next_data = comp_bbs_category_data('view', $sort_where, $sort_order);
