...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
// 목록, 페이지관련
	$list = comp_bbs_info_data('list', $where, $orderby, $page_num, $page_size);
	...
	else
	{
		...
		foreach($list as $k => $data)
		{
			...
			// 첨부파일
				...
				$file_list = comp_bbs_file_data('page', $file_where);
				$total_file = $file_list['total_num'];

			// 코멘트
				$comment_where = " and bco.bs_idx='" . $data['bs_idx'] . "' and bco.b_idx='" . $data['b_idx'] . "'";
				$comment_data = comp_bbs_comment_data('page', $comment_where);
